            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <?php 
                        ...
                        echo '<a href="#!"><img class="card-img-top" src="image/'.$row['hinhminhhoa'].'" alt="..." /></a>';
                        echo '<div class="card-body">';
                        echo '<div class="small text-muted">'.$row['thoigian'].'  '.$row['ngay'].'</div>';
                        echo '<h2 class="card-title">'.$row['tieude'].'</h2>';
                        $message = $row['noidung'];
                        echo '<p class="card-text">'.substr($message,0,270).'...</p>';
                        echo '<a class="btn btn-primary" href="tintuc.php?id='.$row['id'].'" style="background-color: #007b5e;border:#007b5e;">Read more →</a>';
                    ?>      
                        </div>
                    </div>
                    ...
                    <div class="row">
                            <?php
                                ...
                                $sql2 = "SELECT * FROM tintuc WHERE id != $id";
