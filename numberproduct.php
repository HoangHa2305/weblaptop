            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            <li><a class="dropdown-item" style="color:#007b5e;" href="#">Dưới 20 triệu</a></li>
                            <li><a class="dropdown-item" style="color:#007b5e;" href="#">20 - 40 triệu</a></li>
                            <li><a class="dropdown-item" style="color:#007b5e;" href="#">Trên 40 triệu</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <ul class="pagination">
                            <?php 
                                if($tranghientai>1 && $tongsotrang >1){ 
                                    echo '<li class="page-item"><a class="page-link" style="color:#007b5e;" href="numberproduct.php?number='.$limit.'&page='.($tranghientai - 1).'"><i class="bi bi-arrow-left-circle"></i></a></li>';
                                }
                                for($i =1 ; $i <= $tongsotrang;$i++){
                                    if($i == $tranghientai){
                                        ...
                                        echo '<li class="page-item"><a class="page-link" style="color:#007b5e;" href="numberproduct.php?number='.$limit.'&page='.$i.'">'.$i.'</a></li>';
                                    }
                                }
                                if($tranghientai < $tongsotrang && $tongsotrang>1){
                                    echo '<li class="page-item"><a class="page-link" style="color:#007b5e;" href="numberproduct.php?number='.$limit.'&page='.($tranghientai + 1).'"><i class="bi bi-arrow-right-circle"></i></a></li>';
                                }
                            ?>
                        </ul>
                    </nav>
