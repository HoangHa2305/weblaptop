<?php
    $id = $_GET['iddanhmuc'];
     if($_SERVER["REQUEST_METHOD"] == "POST"){
         ...
         $sql = "UPDATE danhmuctintuc SET tendanhmuc = '$tendanhmuc' WHERE id = $id";
    ...
    <?php include('nav.php'); ?>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!--page header-->
                <div class="col-lg-12">
                    <h1 class="page-header">Cập nhật danh mục tin tức</h1>
                </div>
                 <!--end page header-->
            </div>
            <?php 
                $conn1 = mysqli_connect("localhost","root","","giuaki");
                $sql1 = "SELECT * FROM danhmuctintuc WHERE id = $id ";
