...
<html lang="en">
    ...
    <body>
        ...
        <header class="py-5" style="background-color: #007b5e;">
            <div class="container px-4 px-lg-5 my-5">
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM danhmuchanghoa WHERE id = $id";
                    $ketqua = mysqli_query($conn,$sql);
                    $row = mysqli_fetch_array($ketqua);
                    echo '<h1 class="display-4 fw-bolder">Sản phẩm theo giá của hãng '.$row['tendanhmuc'].'</h1>';
                ?>    
        ...
        <?php 
            ...
            $conn = mysqli_connect("localhost","root","","giuaki");
            if($dongia == 1){
                $sql = "SELECT * FROM hanghoa WHERE dongia<20000000 AND danhmuc = $id ORDER BY id DESC ";
            }elseif($dongia ==2){
                $sql = "SELECT * FROM hanghoa WHERE 20000000<=dongia AND dongia<=40000000 AND danhmuc = $id ORDER BY id DESC ";
            }elseif($dongia ==3){
                $sql = "SELECT * FROM hanghoa WHERE dongia>40000000 AND danhmuc = $id ORDER BY id DESC ";
            }
                ...
                <div class="col-sm-2">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            <li><a class="dropdown-item" style="color:#007b5e;" href="priceproducttheohang.php?gia=1&id=<?php echo $id; ?>">Dưới 20 triệu</a></li>
                            <li><a class="dropdown-item" style="color:#007b5e;" href="priceproducttheohang.php?gia=2&id=<?php echo $id; ?>">20 - 40 triệu</a></li>
                            <li><a class="dropdown-item" style="color:#007b5e;" href="priceproducttheohang.php?gia=3&id=<?php echo $id; ?>">Trên 40 triệu</a></li>
                        </ul>
                    </div>
                </div>
            </div>
